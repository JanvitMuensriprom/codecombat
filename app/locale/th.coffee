...
#  new_home:
#    slogan: "สุดยอดเกมที่คุณจะสามารถสนุกพร้อมกับการเรียนรู้ภาษาคอมพิวเตอร์ไปด้วยกัน"
#    classroom_edition: "สำหรับห้องเรียน:"
#    learn_to_code: "หัดเขียนโค้ด:"
#    play_now: "เริ่มเล่นเลย"
#    im_a_teacher: "ฉันเป็นครูผู้สอน"
#    im_a_student: "ฉันคือนักเรียน"
...
#    top_screenshots_hint: "Students write code and see their changes update in real-time"
    designed_with: "เราออกแบบระบบโดยใส่ใจกับการเรียนรู้ที่ง่ายและสนุก"
    real_code: "เรียนรู้จริง เขียนโค้ดจริง"
    from_the_first_level: "ตั้งแต่จุดเริ่มต้น"
    getting_students: "ช่วยให้นักเรียนสามารถเริ่มเรียนรู้หลักการเขียนภาษาในคอมพิวเตอร์และโครงสร้างต่าง ๆ ได้อย่างรวดเร็วและมีประสิทธิภาพ"
    educator_resources: "แหล่งข้อมูลของนักศึกษา"
    course_guides: "พร้อมคู่มือหลักสูตร"
    teaching_computer_science: "การเรียนเขียนภาษาคอมพิวเตอร์ไม่ต้องเสียค่าเรียนราคาแพงอีกต่อไปเพราะเราเป็นส่วนในการสนับสนุนผู้สนใจในการเขียนโปรแกรม"
    accessible_to: "ุทุกคนสามารถเขียนได้"
    everyone: "ด้วยตนเอง"
    democratizing: "หลักสูตรของเราเริ่มสอนตั้งแต่หลักการทำงานจนไปถึงการทำงานจริงเพื่อให้ทุกคนเข้าใจและสามารถเขียนได้ง่ายไม่ว่าจะเป็นเด็กเล็กก็ตาม"
    forgot_learning: "เมื่อคุณได้เข้ามามีส่วนร่วมแล้ว คุณอาจจะล่มไปเลยก็ได้ว่ากำลังเรียนรู้อยู่ในขณะที่สนุกกับการเขียนโค้ดด้วยความเข้าใจของตน"
    wanted_to_do: "การเขียนโปรแกรมเป็นอะไรที่ผมอยากจะทำเป็นที่สุด และไม่เคยคิดเลยว่าจได้สนุกกับการเขียนโค้ดในโรงเรียนแบบนี้"
#    why_games: "ทำไมการเรียนที่มีส่วนผสมร่วมกับการเล่นเกมจึงสำคัญ"
...
#    want_coco: "Want CodeCombat at your school?"
  ...
  nav:
    ...
    my_classrooms: "ชั้นเรียนของเรา"
    my_courses: "หลักสูตรของเรา"
    careers: "ร่วมงานกับเรา"
    facebook: "Facebook"
    twitter: "Twitter"
    create_a_class: "สร้างบทเรียน"
    other: "อื่น ๆ"
    learn_to_code: "มาเรียนเขียนโค้ดกัน!"
    toggle_nav: "Toggle navigation"
    jobs: "อาชีพ"
    schools: "โรงเรียน"
    get_involved: "เข้าร่วมเป็นส่วนหนึ่ง"
    open_source: "เปิดหน้าโค้ดหลัก (GitHub)"
    support: "Support"
    faqs: "คำถามที่พบบ่อย"
    help_pref: "ต้องการความช่วยเหลือหรือ? อีเมล์มาหาเรา"
    help_suff: "และเราจะติดต่อกลับให้เร็วที่สุด!"
    resource_hub: "แหล่งทรัพยากร"
  ...
  diplomat_suggestion:
    ...
    learn_more: "เรียนรู้เพิ่มเติมสำหรับการเป็นผู้แปลภาษา"
    subscribe_as_diplomat: "ลงชื่อเป็นผู้แปลภาษา"
  ...
  play:
    ...
    purchasable: "ซื้อได้"
    available: "มีให้ใช้"
    skills_granted: "ทักษะที่มี"s
    heroes: "เหล่าผู้กล้า"
    achievements: "ความสำเร็จ"
    settings: "การตั้งค่า"
    poll: "โพลล์" # Tooltip on poll button from /play
    next: "ต่อไป" # Go from choose hero to choose inventory before playing a level
    change_hero: "เปลียนผู้กล้า"
    buy_gems: "ซื้ออัญมณี"
    subscription_required: "ต้องสมัครสมาชิคก่อน"
    subscribers_only: "เฉพาะสมาชิกเท่านั้น"
    subscribe_unlock: "สมัครสมาชิกเพื่อปลดล็อก"
    subscriber_heroes: "สมัครวันนี้จะได้รับ Amera Hushbaum,และ Hattori ทันที"
    subscriber_gems: "สมัครสมาชิกวันนี้ซื้อผู้กล้านี้ได้ด้วยอัญมณี"
    anonymous: "ผู้เล่นนรินาม"
    level_difficulty: "ความยาก"
    play_classroom_version: "เริ่มใช้งานแบบห้องเรียน" 
    campaign_beginner: "เริ่มภารกิจ"
     awaiting_levels_adventurer_prefix: "เรามีด่านใหม่ ๆ ทุกสัปดาห์"
    awaiting_levels_adventurer: "ลงทะเบียนเป็นนักผจญภัย"
    awaiting_levels_adventurer_suffix: "เพื่อเป็นคนดแรกที่จะได้ลองเล่นด่านใหม่ก่อนใคร"
    adjust_volume: "ปรับเสียง"
    campaign_multiplayer: "สั่งเวียนผู้เล่น"
    campaign_multiplayer_description: "เขียนโค้ดคำสั่งแข่งขันออนไลน์กับผํู้เล่นคนอื่น ๆ"
    brain_pop_done: "คุณเอาชนะพวกออค์ด้วยโค้ดของคุณแล้ว ยินดีด้วย!"
    brain_pop_challenge: "้ท้าทายตัวคุณเองด้วยการล่นนอีกรอบด้วยภาษาอื่น"
    replay: "เล่นใหม่"
...
#    title: "Excellent Work, Apprentice"
  ...
  login:
    ...
    email_or_username: "อีเมล์ หรือ ชื่อผู้ใช้Email or username"
...
#    load_profile: "Load Google Profile"
    ...
    signup_switch: "ต้องการสร้างบัญชีหรือไม่ ?"

  signup:
    create_student_header: "สร้างบัญชีสำหรับนักเรียน"
    create_teacher_header: "สร้างบัญชีสำหรับผู้สอน"
    create_individual_header: "สร้างบัญชีสำหรับบุคคลทั่วไป"
    email_announcements: "รับข่าวสารผ่านทางอีเมลล์"
    creating: "กำลังสร้างบัญชีใหม่..."
    sign_up: "สมัคร"
    log_in: "เข้าสู่ระบบด้วยรหัสผ่าน"
    required: "คุณจำเป็นต้องเข้าสู่ระบบก่อนที่จะดำเนินการต่อไปได้"
    login_switch: "คุณมีบัญชีอยู่แล้วหรือไม่?"
    school_name: "ชื่อโรงเรียนและเมือง"
    optional: "ตัวเลือก"
